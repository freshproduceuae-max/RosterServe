  ...
  return (
    <div className="flex flex-col gap-400">
      ...
      <div className="rounded-300 bg-surface-cool px-400 py-400">
        ...
        <p className="mt-50 text-body-sm text-neutral-600">Department head</p>
      </div>
      ...
      <section className="flex flex-col gap-300">
        ...
        {eventSummaries.length === 0 ? (
          <p className="text-body text-neutral-600">
            ...
            <Link href="/departments" className="text-brand-calm-600 underline-offset-2 hover:underline">
              View departments →
            </Link>
          </p>
        ) : (
